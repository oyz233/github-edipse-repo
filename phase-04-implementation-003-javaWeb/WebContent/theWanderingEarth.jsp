...
<body class="background1">
	...
	<audio id="waiting"  controls="controls"  src="/static/audio/waiting.mp3" preload="auto"></audio>
	<div id="poem-txt"
	...
	<img src="/static/imgs/earth.png"
		style="position: absolute; right: 10px; top: 600px; width: 150px"
		onclick="run(this);return false" />
	<div id="moviebox" style="margin-top: 100px; display: none"
		align="center">
		<video id="movie" height="500px" controls="controls"
			src="static/imgs/61990981_fd6360c7b3d2674e0b0937c34a4c1b1b_0.mp4" onended="onVideoEnd();" ></video>
	</div>
</body>
</html>